...
public class Flamespawn extends BaseMonster {
    public static final String ID = Flamespawn.class.getSimpleName();
    ...
    public void takeTurn() {
        ...
        addToBot(new ApplyPowerAction(p, this, new BurnPower(p, this, 1), 1));
    }
