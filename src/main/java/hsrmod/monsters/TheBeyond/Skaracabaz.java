...
public class Skaracabaz extends BaseMonster implements OnCardUseSubscriber {
    ...
    public void damage(DamageInfo info) {
        super.damage(info);
        // TODO: make DecayEulogyPower ignore toughness locking
        /*if (info.type == DamageInfo.DamageType.HP_LOSS && info instanceof ElementalDamageInfo) {
            ToughnessPower toughnessPower = (ToughnessPower) getPower(ToughnessPower.POWER_ID);
            if (toughnessPower != null && toughnessPower.getLocked()) {
                toughnessPower.alterPower(-((ElementalDamageInfo) info).tr);
            }
        }*/
