...
public class SporePower extends DebuffPower {
    public static final String POWER_ID = AndroidTestMod.makePath(SporePower.class.getSimpleName());
    ...
    public void trigger(){
        ...
        addToTop(new ApplyPowerAction(owner, AbstractDungeon.player, new SporePower(owner, -amount), -amount));
