...
public abstract class BaseRelic extends CustomRelic {
    ...
    public BaseRelic(String id){
        super(Hsrmod.makePath(id),
                AssetLoader.getTexture(Hsrmod.MOD_NAME, "HSRModResources/img/relics/" + id + ".png"),
                AssetLoader.getTexture(Hsrmod.MOD_NAME, "HSRModResources/img/relics/outline/" + id + ".png"),
