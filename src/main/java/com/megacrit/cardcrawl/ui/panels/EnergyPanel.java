...
public class EnergyPanel extends AbstractPanel {
    ...
    public EnergyPanel() {
        super(198.0F * Settings.xScale, 190.0F * Settings.yScale, -480.0F * Settings.scale, 200.0F * Settings.yScale, 12.0F * Settings.scale, -12.0F * Settings.scale, (Texture)null, true);
    ...
    public static void addEnergy(int e) {
        e = SubscriptionManager.getInstance().triggerPreEnergyChange(e);
        totalCount += e;
        if (totalCount >= 9) {
    ...
    public void render(SpriteBatch sb) {
        ...
        if (this.tipHitbox.hovered && AbstractDungeon.getCurrRoom().phase == RoomPhase.COMBAT && !AbstractDungeon.isScreenUp) {
